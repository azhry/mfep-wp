...
public class Data {
    ...
    private double total_bobot_evaluasi_ternormalisasi;
    ...
    public double getTotal_bobot_evaluasi_ternormalisasi() {
        return total_bobot_evaluasi_ternormalisasi;
    }

    public void setTotal_bobot_evaluasi_ternormalisasi(double total_bobot_evaluasi_ternormalisasi) {
        this.total_bobot_evaluasi_ternormalisasi = total_bobot_evaluasi_ternormalisasi;
    }
